require 'xml_mini'
require 'xml_mini/core_ext/array/wrap'
require 'xml_mini/core_ext/object/blank'
require 'xml_mini/core_ext/object/try'
...
class Hash
  ...
  class << self
    ...
    def from_xml(xml, disallowed_types = nil)
      XmlMini::XMLConverter.new(xml, disallowed_types).to_h
    end
